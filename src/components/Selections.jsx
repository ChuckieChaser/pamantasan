...
const SEGMENT_CONTAINER_STYLE = 'h-9 inline-flex items-center p-1 bg-surface border border-surface-border rounded-md gap-1.5 box-border';
const SEGMENT_ITEM_BASE_STYLE = 'h-6 px-2.5 text-[11px] font-medium rounded-sm inline-flex items-center justify-center gap-1 transition-colors cursor-pointer disabled:cursor-not-allowed disabled:opacity-50';
